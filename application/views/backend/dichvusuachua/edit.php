      ...
      <div class="box box-primary">
        ...
        <form id="frm-admin" method="post" action="">
          <div class="box-body">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="<?php if(isset($dichvusuachua['name']) && $dichvusuachua['name']!=''){ echo $dichvusuachua['name']; }?>">
                </div>
            </div>
            <div class="form-group">
                <?php if($dichvusuachua['publish'] == 0){ ?>
          ...
          <div class="box-footer">
            ...
            <a href="admin/dichvusuachua/index" class="btn btn-success btn-flat"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Hủy</a>
          </div>
        </form>
      </div>
    </div>
