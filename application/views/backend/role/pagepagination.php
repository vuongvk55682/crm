<div class="col-md-6">
  <div id="page_pagination" style="display: inline-block;">
    <span><?php echo isset($ci_role_num['num_from'])? $ci_role_num['num_from']:''; ?></span>
    &nbsp;
    <span>-</span>
    &nbsp;
    <span><?php echo isset($ci_role_num['num_to'])? $ci_role_num['num_to']:''; ?></span>
    &nbsp;
    <span>của</span>
    &nbsp;
    <span><?php echo isset($ci_role_num['count_kh'])? $ci_role_num['count_kh']:''; ?></span>
    &nbsp;
    <input type="hidden" name="ci_role_num" id="ci_role_num" value="<?php echo isset($ci_role_num['count_kh'])? $ci_role_num['count_kh']:''; ?>">
    <span>
      <a onclick="pagePrev()" id="page_prev" class="btn btn-default">
        <input type="hidden" name="num_prev" id="num_prev" value="<?php if (isset($ci_role_num['num_from'])) {$num_prev = (int)$ci_role_num['num_from'] - 1; echo $num_prev; } ?>">
        <i class="fa fa-chevron-left" aria-hidden="true"></i> 
      </a>
    </span>
    <span>
      <a onclick="pageNext()" id="page_next" class="btn btn-default">
        <input type="hidden" name="num_next" id="num_next" value="<?php echo isset($ci_role_num['num_to'])? $ci_role_num['num_to']:''; ?>">
        <i class="fa fa-chevron-right" aria-hidden="true"></i>
      </a>
    </span>
    <span>Trang</span>
    <span>
      <input type="text" name="page_index" id="page_index" maxlength="<?php echo isset($ci_role_num['max_length'])? $ci_role_num['max_length']:''; ?>" value="<?php echo isset($ci_role_num['page_change'])? $ci_role_num['page_change']:''; ?>" placeholder="" style="width: 3em;text-align: center;">
    </span>
    &nbsp;
    <span>/</span>
    <span><?php echo isset($ci_role_num['page_kh'])? $ci_role_num['page_kh']:''; ?></span>
    <input type="hidden" name="page_kh" id="page_kh" value="<?php echo isset($ci_role_num['page_kh'])? $ci_role_num['page_kh']:''; ?>">
  </div>
</div>
<div class="clear"></div>
...
<table id="example1" class="table table-bordered table-striped">
    <thead>
        <tr>
          ...
          <th class="div_center">Tên nhóm</th> 
    ...
    <tbody>
      <?php if(isset($role) && $role!=NULL){ ?>
        ...
        <tr> 
          ...
          <td><a href="admin/role/edit/<?php echo $val['_id']?>"><?php echo $val['name'];?></a></td>
          <td><?php echo $created_str; ?></td>
          <td><?php echo $updated_str; ?></td>
          <td class="div_center"><input class="sort div_center" name="sort" control="role" value="<?php echo $val['sort'];?>" id="sort" size="5" seq="<?php echo $val['_id']?>"></td>
          <td class="div_center publish"><a onClick="show('<?php echo $val['_id']?>');" control="role" title="Hiển thị" class="div_hienthi<?php echo $val['_id']?> div_hienthi" divid="div_hienthi<?php echo $val['id']?>" seq="<?php echo $val['_id']?>">
          ...
          <td class="div_center tool">
            <a href="admin/role/edit/<?php echo $val['_id']?>"><i class="fa fa-edit"></i></a>
            <a onClick="del('<?php echo $val['_id']?>');" class="delete delete<?php echo $val['_id']?>" seq="<?php echo $val['_id']?>" control="role"><i class="fa fa-trash"></i></a>
            <a href="admin/role/permission?id_role=<?php echo $val['_id']?>"><i class="fa fa-wrench"></i></a>
          </td>
        </tr>
        <?php } ?>
      <?php } ?>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var ci_role_num  = $('#ci_role_num').val();
    var num_minus     = parseInt(ci_role_num) - parseInt(num_prev);
