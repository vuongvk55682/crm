                ...
                <div id="div_load">
                  <div class="col-md-6">
                    <div id="page_pagination" style="display: inline-block;">
                      ...
                      <span>Trang</span>
                      <span>
                        <input type="text" name="page_index" id="page_index" value="1" maxlength="<?php echo isset($ci_role_num['max_length'])? $ci_role_num['max_length']:''; ?>" style="width: 3em;text-align: center;">
                      </span>
                      &nbsp;
                      <span>/</span>
...
<script type="text/javascript">
  ...
  function pagePrev(){
    var num_prev        = $('#num_prev').val();
    var page_index      = $('#page_index').val();
    $.post("admin/role/pagepagination",{ num_prev:num_prev, page_index:page_index },function(data){
      $('#div_load').html( data );
    });
  }
  function pageNext(){
    ...
    var page_index      = $('#page_index').val();
    $.post("admin/role/pagepagination",{ num_next:num_next, page_index:page_index },function(data){
      $('#div_load').html( data );
    });
  }
  function pageChange(){
    var page_index      = $('#page_index').val();
    $.post("admin/role/pagepagination",{ page_index:page_index },function(data){
      $('#div_load').html( data );
    });
  }
</script>