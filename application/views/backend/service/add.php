      ...
      <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="name" id="name" control="service">
                </div>
            </div>
            <div class="form-group">
        ...
        <div role="tabpanel" class="tab-pane" id="en">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                        <input type="text" class="form-control" name="en_name" id="en_name" control="service">
                    </div>
                </div>
                <div class="form-group">
                    <label>Mô tả</label>
        ...
        <div class="clear"></div>
          <div class="box-footer">
            ...
            <a href="admin/service/index" class="btn btn-success btn-flat"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Trở về</a>
          </div>
      </div>
    </div>
    </form>
