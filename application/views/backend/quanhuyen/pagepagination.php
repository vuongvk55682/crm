<div class="col-md-6">
  <div id="page_pagination" style="display: inline-block;">
    <span><?php echo isset($quanhuyen_num['num_from'])? $quanhuyen_num['num_from']:''; ?></span>
    &nbsp;
    <span>-</span>
    &nbsp;
    <span><?php echo isset($quanhuyen_num['num_to'])? $quanhuyen_num['num_to']:''; ?></span>
    &nbsp;
    <span>của</span>
    &nbsp;
    ...
    <span>
      <a onclick="pagePrev()" id="page_prev" class="btn btn-default">
        <input type="hidden" name="num_prev" id="num_prev" value="<?php if (isset($quanhuyen_num['num_from'])) {$num_prev = (int)$quanhuyen_num['num_from'] - 1; echo $num_prev; } ?>">
        <i class="fa fa-chevron-left" aria-hidden="true"></i> 
      </a>
    </span>
    <span>
      <a onclick="pageNext()" id="page_next" class="btn btn-default">
        <input type="hidden" name="num_next" id="num_next" value="<?php echo isset($quanhuyen_num['num_to'])? $quanhuyen_num['num_to']:''; ?>">
        <i class="fa fa-chevron-right" aria-hidden="true"></i>
      </a>
    </span>
    <span>Trang</span>
    <span>
      <input type="text" name="page_index" id="page_index" maxlength="<?php echo isset($quanhuyen_num['max_length'])? $quanhuyen_num['max_length']:''; ?>" value="<?php echo isset($quanhuyen_num['page_change'])? $quanhuyen_num['page_change']:''; ?>" placeholder="" style="width: 3em;text-align: center;">
    </span>
    &nbsp;
    <span>/</span>
...
<table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
      <?php if(isset($quanhuyen) && $quanhuyen!=NULL){ ?>
        <?php $i = $quanhuyen_num['num_from'] - 1; ?>
