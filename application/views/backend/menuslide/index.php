            ...
            <div class="box-body">
                ...
                <div class="row">
                  <div class="input-group">
                      <input type="text" class="form-control" id="search" name="search" control="menuslide">
                ...
                <div class="input-group">
                    ...
                    <select class="form-control select2" name="typeid" id="typeid" control="menuslide">
                ...
                <div class="row">
                    <a href="admin/menuslide/add" type="button" class="btn btn-success btn-flat"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Thêm mới</a>
                    <a control="menuslide" id="del-all" type="button" class="btn btn-success btn-flat del"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Xóa tất cả</a>
                    <a control="menuslide" id="show-all" type="button" class="btn btn-success btn-flat shows"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Hiển thị</a>
                </div>
                </div>
