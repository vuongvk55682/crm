    ...
    <div class="box box-primary">
      ...
      <form id="frm-admin" onsubmit="return checkNganhhoc();" method="post" action="">
        <div class="box-body">
          <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="nganhhoc_ten" name="nganhhoc_ten">
              </div>
          </div>
          <div class="form-group">
        ...
        <div class="box-footer">
          ...
          <a href="admin/nganhhoc/index" class="btn btn-success btn-flat"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Trở về</a>
        </div>
      </form>
    </div>
  </div>
