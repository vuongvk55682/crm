      ...
      <form id="frm-admin" onsubmit="return checkNguonkhachhang();" method="post" action="">
        <div class="box-body">
          <div class="form-group">
              <label for="name">Nguồn khách hàng</label>
              <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-user-plus" aria-hidden="true"></i></div>
                <input type="text" class="form-control" id="nguonkh_ten" name="nguonkh_ten">
              </div>
          </div>
          <div class="form-group">
        ...
        <div class="box-footer">
          ...
          <a href="admin/nguonkhachhang/index" class="btn btn-success btn-flat"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Trở về</a>
        </div>
      </form>
    </div>
  </div>
