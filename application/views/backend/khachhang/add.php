    ...
    <div class="box box-primary">
      ...
      <form id="frm-admin" onsubmit="return checkKhachhang();" method="post" action="" enctype="multipart/form-data">
                      ...
                      <div id="form_thongtinkh" class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="kh_ten" id="kh_ten" placeholder="Tên khách hàng" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="kh_dienthoai" id="kh_dienthoai" placeholder="Điện thoại" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="kh_diachi" id="kh_diachi" placeholder="Địa chỉ" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="kh_ma" id="kh_ma" placeholder="Mã khách hàng" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="kh_masothue" id="kh_masothue" placeholder="Mã số thuế" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <div class="input-group">
                            ...
                            <input type="email" class="form-control" name="kh_email" id="kh_email" placeholder="Email" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="kh_fax" id="kh_fax" placeholder="" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="kh_logo" id="kh_logo" placeholder="" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <input type="text" class="form-control" name="kh_sothich" id="kh_sothich" placeholder="" value="">
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                            Chứng minh thư
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="kh_cmnd" id="kh_cmnd" placeholder="Số CMND" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask name="kh_sinhnhat" id="kh_sinhnhat" />
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <label class="radio-inline">
                            <input type="radio" name="kh_gioitinh" id="kh_gioitinh" value="1" checked>
                            Nam
                          </label>
                          <label class="radio-inline">
                        ...
                        <div class="col-xs-12">
                          <div class="row">
                            <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10">
                              <div id="box_img_kh" class="div_kh_anh"></div>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="kh_website" id="kh_website" placeholder="Tên trang Web" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                          ...
                          <textarea class="form-control" name="kh_mota" id="kh_mota" rows="4"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="row">
                      <div id="form_lienhe">
                        ...
                        <div id="form_lh_goc" class="col-md-12">
                          <div class="col-md-12 border">
                            <div class="row margintop10">
                              <div class="col-md-7">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="lh_ten[]" id="lh_ten" placeholder="Họ tên" value="">
                                </div>
                              </div>
                              <div class="col-md-5">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="lh_vitri[]" id="lh_vitri" placeholder="" value="">
                                </div>
                              </div>
                              <div class="clear"></div>
                              <div class="col-md-7 col-sm-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="lh_dienthoai[]" id="lh_dienthoai" placeholder="Điện thoại" value="">
                                </div>
                              </div>
                              <div class="col-md-5">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask name="lh_sinhnhat[]" id="lh_sinhnhat" />
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="email" class="form-control" name="lh_email[]" id="lh_email" placeholder="Email" value="">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label">
                              ...
                              <textarea class="form-control" name="lh_ghichu[]" id="lh_ghichu" rows="2"></textarea>
                            </div>
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  <div class="checkbox">
                                    <label class="control-label">
                                      <input type="checkbox" name="lh_nhanmail[]" id="lh_nhanmail" value="1">
                                      Nhận Email
                                    </label>
                                  </div>
                                </div>
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label class="radio-inline margintop10">
                                    <input type="radio" name="lh_lienhechinh" id="lh_lienhechinh" value="1" placeholder="" checked>
                                    Liên hệ chính
                                  </label>
                                </div>
                              </div>
                      ...
                      <div id="form_gioithieu" class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="gt_ten" id="gt_ten" placeholder="Tên người giới thiệu" value="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select class="form-control" name="gt_moiqh" id="gt_moiqh" data-placeholder="Chọn mối quan hệ">
        ...
        <div class="box-footer">
          ...
          <a href="admin/khachhang/index" class="btn btn-success btn-flat"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Trở về</a>
        </div>
      </form>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  $("#lh_sinhnhat").inputmask("dd/mm/yyyy", {"placeholder": "dd/mm/yyyy"});
