      ...
      <div class="box box-primary">
        ...
        <form id="frm-admin" method="post" action="" enctype="multipart/form-data">
          <div class="box-body">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="<?php if(isset($partner['name']) && $partner['name']!=''){ echo $partner['name']; }?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="url" name="url" value="<?php if(isset($partner['url']) && $partner['url']!=''){ echo $partner['url']; }?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10">
                    <div id="box_img">
                        <?php if($partner['image']!=''){ ?>
                            <img src="upload/partner/<?php echo $partner['image'];?>" alt="" class="image_admin">
                        <?php } ?>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="width" id="width" value="<?php if(isset($partner['width']) && $partner['width']!=''){ echo $partner['width']; }?>">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="height" id="height" value="<?php if(isset($partner['height']) && $partner['height']!=''){ echo $partner['height']; }?>">
                        <div class="input-group-addon">px</div>
                    </div>
                    </div>
                    </div>
          ...
          <div class="box-footer">
            ...
            <a href="admin/partner/index" class="btn btn-success btn-flat"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Hủy</a>
          </div>
        </form>
      </div>
    </div>
