<div class="col-md-3">
	<div class="info_login clearfix">
		...
		<ul>
			...
			<li class="active"><a href="danh-sach-san-pham-yeu-thich.html">Danh sách yêu thích</a></li>
...
<div class="col-md-9">
	...
	<div class="list_product">
			 	...
			 	<div class="item">
				 	<a href="<?php echo $url_product; ?>">
				 		<div class="info-image">
				        	...
				        	<a class="del" onClick="delLike(<?php echo $val_product['id'];?>,<?php echo $data_index['info_user']['id'];?>);" title="Xóa sản phẩm yêu thích"><img src="public/images/icon/trash.png" alt=""></a>
				        </div>
				        <div class="info-des">
		...
		<?php }else{ ?>
    		<div class="div_error_like">Chưa có sản phẩm yêu thích...</div>
    	<?php } ?>
	</div>
