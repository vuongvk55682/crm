<div class="col-md-3">
	<div class="info_login clearfix">
		...
		<ul>
			...
			<li class="active"><a href="san-pham-danh-gia.html">Sản phẩm đánh giá</a></li>
			 	...
			 	<div class="item">
				 	<a href="<?php echo $url_product; ?>">
				 		<div class="info-image">
				        	...
				        	<a class="del" onClick="delRating(<?php echo $val_product['id'];?>,<?php echo $data_index['info_user']['id'];?>);" title="Xóa sản phẩm để dành mua sau"><img src="public/images/icon/trash.png" alt=""></a>
				        </div>
				        <div class="info-des">
